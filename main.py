...
token = "7476733231:AAERIWndDBrEd1zbcbrEpS26yRtmHJHddFk" #توكنك
...
def reset(msg):
    if db.exists('session') is False:
    	bot.send_message(chat_id, text="تخصص لجلب خاصيات\n– – – – –\nمطوره : @arageDoctor", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="اضف حساب",callback_data="add")]]))
    	return 
    bot.send_message(chat_id, text="@arageDoctor", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="فحص عشوائي", callback_data="start")],[InlineKeyboardButton(text="من ملف", callback_data="combo"),InlineKeyboardButton(text="تثبيت", callback_data="us1")],[InlineKeyboardButton(text="اختيار نوع", callback_data="type"),]]))
...
def startB(msg):
    if msg.chat.id != int(chat_id): return
    	...
    	if db.exists('session') is False:
    		...
    		return 
    	bot.send_message(chat_id, text="اهلا بك عزيزي\nبوت متخصص لجلب خاصيات\n– – – – –\nمطوره : @arageDoctor", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="فحص عشوائي", callback_data="start")],[InlineKeyboardButton(text="من ملف", callback_data="combo"),InlineKeyboardButton(text="تثبيت", callback_data="us1")],[InlineKeyboardButton(text="اختيار نوع", callback_data="type"),]]))
